...
+ O efeito das medidas de contenção pode ser modelado: se houver __confinição__ o número de suscetíveis não diminui, mas a transmissão (matriz de contato) muda

---
## Modelagem matemática

+ Efeito do confinamento (março de 2020) e outros cenários: abertura de escolas, rastreio de contatos, vacinação com 1 e 2 doses, etc
...
???
três cenários: nenhum, rexalamento das medidas agora, mantém isolamento até o final do ano
